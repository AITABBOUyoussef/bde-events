<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 min-h-screen flex items-center justify-center">
        <div class="max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- LE TICKET -->
            <div
                class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transform transition-all hover:scale-[1.02]">

                <!-- HEADER DU TICKET (En Vert) -->
                <div
                    class="bg-gradient-to-r from-green-500 to-green-700 px-8 py-6 text-white flex justify-between items-center relative">
                    <div>
                        <span
                            class="bg-white/20 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest border border-white/30 backdrop-blur-sm">
                            Billet Officiel
                        </span>
                    ...
                    <!-- Logo BDE Sghir -->
                    <div
                        class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-inner transform rotate-3">
                ...
                <div class="px-8 py-6 grid grid-cols-2 gap-6 relative">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-gray-900">
                            {{ \Carbon\Carbon::parse($ticket->date)->translatedFormat('d M Y') }}</p>
                        <p class="text-sm font-medium text-gray-600">
                            {{ \Carbon\Carbon::parse($ticket->heure)->format('H:i') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <span
                            class="inline-flex items-center justify-center px-3 py-1 rounded-full text-sm font-bold {{ $ticket->prix > 0 ? 'bg-amber-100 text-amber-800' : 'bg-green-100 text-green-800' }}">
                ...
                <div class="bg-gray-50 px-8 py-8 text-center flex flex-col items-center justify-center">
                    ...
                    <!-- L-Code stylisé -->
                    <div
                        class="bg-white border-2 border-gray-800 px-6 py-3 rounded-lg shadow-sm w-full max-w-xs mx-auto">
                    ...
                    <div class="mt-8">
                        <a href="{{ route('dashboard') }}"
                            class="text-green-600 font-bold text-sm hover:text-green-700 transition flex items-center justify-center gap-2">
