    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Retrouvez ici tous les tickets des événements auxquels vous êtes
                    inscrit.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @forelse ($reservations as $reservation)
                    ...
                    <div
                        class="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100 flex flex-col justify-between transform transition hover:scale-[1.02]">

                        <!-- Header dyal l-Ticket -->
                        <div
                            class="bg-gradient-to-r from-green-500 to-green-700 px-6 py-5 text-white flex justify-between items-center">
                            <div>
                                <span
                                    class="bg-white/20 text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-widest border border-white/30">
                                    Validé
                                </span>
                                <!-- Ism l-Event (Kan-وصلou lih b relation $reservation->event->titre) -->
                                <h4 class="text-xl font-black mt-2 leading-tight">
                                    {{ $reservation->event->titre ?? 'Événement supprimé' }}</h4>
                            </div>
                        ...
                        <div class="p-6 space-y-3 text-sm font-medium text-gray-700">
                            <div class="flex items-center gap-3">
                                ...
                                <span>{{ \Carbon\Carbon::parse($reservation->event->date)->translatedFormat('d M Y') }}
                                    à {{ \Carbon\Carbon::parse($reservation->event->heure)->format('H:i') }}</span>
                            </div>
                        ...
                        <div class="bg-gray-50 p-6 text-center">
                            <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-2">Code de
                                Réservation</p>
                            <div
                                class="bg-white border border-gray-300 py-2.5 px-4 rounded-xl shadow-sm inline-block w-full">
                ...
                @empty
                    ...
                    <div
                        ...
                        <div
                            class="mx-auto w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mb-4 text-gray-400">
                        ...
                        <p class="text-gray-500 mb-6">Vous n'avez encore réservé aucune place pour les événements à
                            venir.</p>
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-md transition">
