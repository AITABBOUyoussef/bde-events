            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                <div class="p-8 sm:p-10">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-5">
                        ...
                        <p class="text-sm text-gray-500 mt-2">Remplissez les informations ci-dessous pour publier un
                            événement officiel sur la plateforme du BDE.</p>
                    </div>
                    ...
                    <form action="{{ route('events.store') }}" method="POST">
                        ...
                        <!-- Titre -->
                        <div class="mb-6">
                            <label for="titre" class="block text-sm font-bold text-gray-700 mb-2">Titre de
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label for="date" class="block text-sm font-bold text-gray-700 mb-2">Date <span
                            ...
                            <div>
                                <label for="heure" class="block text-sm font-bold text-gray-700 mb-2">Heure <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div>
                                <label for="lieu" class="block text-sm font-bold text-gray-700 mb-2">Lieu <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="prix" class="block text-sm font-bold text-gray-700 mb-2">Prix (DH) <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="jauge_maximale" class="block text-sm font-bold text-gray-700 mb-2">Places
                                    Max <span class="text-red-500">*</span></label>
                                <input type="number" min="1" name="jauge_maximale" id="jauge_maximale"
                                    value="{{ old('jauge_maximale') }}" required
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                            ...
                            <a href="{{ route('admin.dashboard') }}"
                                class="px-6 py-3 text-sm font-bold text-gray-600 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-all">
                                Annuler
                            </a>

                            <!-- Bouton Publier (VIP Style) -->
                            <button type="submit"
                                class="px-8 py-3 text-sm font-bold text-white bg-gradient-to-r from-gray-900 to-black border border-amber-500/50 rounded-xl shadow-lg hover:shadow-amber-500/20 hover:scale-105 transition-all flex items-center gap-2 group">
                                <svg class="w-5 h-5 text-amber-400 group-hover:animate-bounce" fill="none"
